...
if exercise_menu == "전체 보기 / 개요" or exercise_menu == "② 준비운동":
    ...
    str.image("https://mblogthumb-phinf.pstatic.net/MjAxOTAxMTBfMjI3/MDAxNTQ3MDgyMDU5NTMx.Vp-FwCyAhoC-JjJwrpEkO0-pOj-uZM3D8KqSwaqpQ20g.NEnY1ARZ3kc5smQVZZYY1hJ6xUKjr-2yU_Nm0tJYzNIg.JPEG.mombompt/ac81c6e64387b719b3a7818407ffab35.jpg?type=w800", caption="네발기기 흉추 로테이션 동작 가이드")
...
if exercise_menu == "전체 보기 / 개요" or exercise_menu == "③ 본운동 1️⃣":
    ...
    str.image("https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTQBnFe0M5_wS1ZawgpO_WIp9sNH0KEh59PSQ&s", caption="Hook lying 드로우-인 동작 가이드")
    
    str.success("**🏃 수행 방법**\n\n갈고리 누운 자세에서 무릎 사이에 필라테스 링을 위치시키고, 숨을 내쉬며 링을 조임 cow 동시에 배꼽을 척추 쪽으로 당깁니다.")
    str.error("**🔍 파트너 체크리스트**\n\n허리가 과도하게 바닥을 누르거나 꺾이지 않는지, 엉덩이 근육이 과개입하지 않는지 확인하세요.")
    str.warning("**🗣️ 치료사 큐잉**\n\n“허리가 바닥에 가볍게 밀착되는 임프린팅 가이드를 유지하세요.”, “지퍼를 채우듯 아랫배와 허벅지 안쪽을 동시에 조입니다.”")
...
if exercise_menu == "전체 보기 / 개요" or exercise_menu == "③ 본운동 2️⃣":
    ...
    str.image("https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQ_yoHwwy8Uc2d4LzhWXHldtNyhwSkLgNPFfw&s", caption="미니 런지 + 세라밴드 PNF 동작 가이드")
...
if exercise_menu == "전체 보기 / 개요" or exercise_menu == "③ 본운동 3️⃣":
    ...
    str.image("blob:https://gemini.google.com/790820c4-a36b-4305-ad18-2c7b02a9d53c", caption="이중과제 동작 가이드")
...
if exercise_menu == "전체 보기 / 개요" or exercise_menu == "④ 마무리운동":
    ...
    str.image("str.image("https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSF57QUYX1LtsaLGyZ6lPilQbF7GWsCFa5ZAw&s", caption="마무리 롤 업 앤 다운 덩작 가이드")
